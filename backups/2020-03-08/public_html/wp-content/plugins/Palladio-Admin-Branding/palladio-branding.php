<?php
/*
Plugin Name: Palladio Administration Branding 
Plugin URI: http://www.palladio.ca
Description: Generate a humans.txt plus adds a nice login-logo, and contact info to the footer
Version: 1.1
Author: Laird Farquharson
Author URI: http://www.palladio.ca
License: GPLv2
*/
...
function custom_login_logo() {
	echo '<style>h1 a, h1 a:hover, h1 a:focus { background-image: url(http://www.palladio.ca/tools/powered-by-palladio.png) !important; }</style>';
}
...
function change_footer_admin() {
	echo 'For support, please call for support at 647-464-3773 or email <a href="mailto:support@palladio.ca">support@palladio.ca</a>';
}
...
<?php }
   ...
   */
  function admin_menu() {
    add_options_page( __('Humans dot txt', 'humans-dot-txt'), __('Humans dot txt', 'humans-dot-txt'), 'manage_options', 'humans-dot-txt', array($this, 'options_page'));    
  }
  ...
  function admin_init() {
    ...
    wp_enqueue_script('jquery.autogrow', plugins_url() . '/humans-dot-txt/js/jquery.autogrow.js', array('jquery'), 1, false);
    ...
    register_setting('humans-dot-txt', 'plugins_separator', create_function('$a', 'return $_POST["plugins_separator"];'));
    ...
    register_setting('humans-dot-txt', 'authors_separator', create_function('$a', 'return $_POST["authors_separator"];'));
