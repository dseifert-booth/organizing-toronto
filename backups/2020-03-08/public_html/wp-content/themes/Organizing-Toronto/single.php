<?php get_header(); ?>
	...
	<div id="content" style="<?php echo $content_css; ?>">
		...
		<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
			...
			<?php endif;
			if($data['featured_images'] && $data['featured_images_single']):
...
<section class="reading-box"><a href="/contact/" target="" class="continue button large green">Contact Us</a><h2>The best thing you can do is start the organizing process</h2><p>Contact us to book a free, no obligation consultation!</p><a href="/contact/" target="" class="continue mobile-button button large green">Contact Us</a></section>
			...
			<div class="share-box">
				...
				<ul>
					...
					<li class="custom">
                    	<a href="https://twitter.com/share" data-url="<?php the_permalink(); ?>" data-text="<?php the_title(); ?>" data-via="OrganizingGuy">
					...
					<li class="custom">
						<a href="http://reddit.com/submit?url=<?php the_permalink(); ?>&amp;title=<?php the_title(); ?>">
							<img src="<?php bloginfo('template_directory'); ?>/images/reddit.png" alt="" />
						</a>
						<div class="popup">
							<div class="holder">
								<p>Reddit</p>
					...
					<li class="custom">
						<a href="http://www.tumblr.com/share/link?url=<?php echo urlencode(get_permalink()); ?>&amp;name=<?php echo urlencode($post->post_title); ?>&amp;description=<?php echo urlencode(get_the_excerpt()); ?>">
							<img src="<?php bloginfo('template_directory'); ?>/images/tumblr.png" alt="" />
						</a>
						<div class="popup">
							<div class="holder">
								<p>Tumblr</p>
					...
					<li class="custom">
						<a href="http://google.com/bookmarks/mark?op=edit&amp;bkmk=<?php the_permalink(); ?>&amp;title=<?php the_title(); ?>">
							<img src="<?php bloginfo('template_directory'); ?>/images/google.png" alt="" />
						</a>
						<div class="popup">
							<div class="holder">
								<p>Google +1</p>
					...
					<li class="custom">
						<a href="mailto:?subject=<?php the_title(); ?>&amp;body=<?php the_permalink(); ?>">
							<img src="<?php bloginfo('template_directory'); ?>/images/mail.png" alt="" />
						</a>
						<div class="popup">
							<div class="holder">
								<p>Email</p>
