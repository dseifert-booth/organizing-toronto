...
if (!class_exists('Google_Client')) {
  require_once dirname(__FILE__) . '/Google2/autoload.php';
}
 ...
 * of sizable data.
 */
class IWP_MMB_Google_Http_MediaFileUpload
{

public function IWP_setResumeUri($resumeUri) { $this->resumeUri = $resumeUri; }
public function IWP_setProgress($progress) { $this->progress = $progress; }
//N.B. a public method getResumeUri already exists - and does something completely different
public function IWP_getResumeUri() { return $this->resumeUri; }
